...
def detec(image):
    ...
    net = cv2.dnn.readNetFromCaffe(prototxt_path, weights_path)  # Alterei de readNet para readNetFromCaffe
...
def loop_folder(folder_in):
    main_dir = os.getcwd()  # Adicionei essa linha para garantir que main_dir seja definido corretamente
