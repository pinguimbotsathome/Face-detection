...
prototxtPath = "/content/face-mask-detector/code/opencv_face_detector/deploy.prototxt"
weightsPath = "/content/face-mask-detector/code/opencv_face_detector/res10_300x300_ssd_iter_140000.caffemodel"

face_detector = cv2.dnn.readNet(prototxtPath, weightsPath)
# load the face mask detector model
print("[INFO] loading face mask detector model...")
model = load_model('/content/face-mask-detector/code/face_mask_detector.h5')


image = cv2.imread('/content/Proctoring-AI/face_detection/faces/1.jpg')
orig = image.copy()
(h, w) = image.shape[:2]
